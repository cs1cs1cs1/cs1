...
def darker(pixel):
    if 10 <= int(pixel[0]) <= 255:
        dred_int = int(pixel[0]) - 10
    else: dred_int = 0
    
    if 10 <= int(pixel[1]) <= 255:
        dgreen_int = int(pixel[1]) - 10
    else: dgreen_int = 0
    
    if 10 <= int(pixel[2]) <= 255:
        dblue_int = int(pixel[2]) - 10
    else: dblue_int = 0

    return (dred_int, dgreen_int, dblue_int)

def lighter(pixel):
    if 0 <= int(pixel[0]) <= 245:
        lred_int = int(pixel[0]) + 10
    else: lred_int = 255
    
    if 0 <= int(pixel[1]) <= 245:
        lgreen_int = int(pixel[1]) + 10
    else: lgreen_int = 255
    
    if 0 <= int(pixel[2]) <= 245:
        lblue_int = int(pixel[2]) + 10
    else: lblue_int = 255

    return (lred_int, lgreen_int, lblue_int)
